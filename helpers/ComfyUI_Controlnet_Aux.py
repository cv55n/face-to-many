...
class ComfyUI_Controlnet_Aux:
    ...
    # os modelos de pré-processador controlnet não estão incluídos no json da api
    #
    # é preciso adicioná-los manualmente com base nos nós que estão sendo usados para
    # evitar que sejam baixados automaticamente de outro lugar
    @staticmethod
